...
import burgerglow from "@/assets/images/burgerglow.png";
import burgerOne from "@/assets/images/burger-one.png";
import aurorawrap from "@/assets/images/aurorawrap.png";
...
import starlitsushi from "@/assets/images/starlitsushi.png";
...
export const offers = [
    {
        ...
        title: "AURORA COMBO",
        image: aurorawrap,
        color: "#FF6B4A",    // Soft coral-red (appetite + premium)
    },
    {
        id: 2,
        title: "BURGER GLOW",
        image: burgerglow,
        color: "#FF8C71",    // Peachy salmon (warm, inviting)
    },
    {
        id: 3,
        title: "VELVET TACO",
        image: velvettaco,
        color: "#2E8B57",    // Seafoam green → fresh, premium (way better than dark teal)
    },
    {
        id: 4,
        title: "STAR SUSHI",
        image: starlitsushi,
        color: "#FFB84A",    // Golden mango (replaces neon yellow—luxurious)
    }
];
